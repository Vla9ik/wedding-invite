...
export const config = {
  ...
  letter: {
    body: 'Сиздерди бул жылуу күндү менен бөлүшүүгө чакырам: кучакташуу, бий жана себепсиз жылмайткан жеңил кубаныч менен. Өзүңүздөрдөй эле келиңиздер — мага жөн эле жаныңызда болуу маанилүү.',
  },
  photos: [
